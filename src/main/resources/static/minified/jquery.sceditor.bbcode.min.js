...
!function (o) {
    ...
    var be = e.bind(null, "string"), xe = e.bind(null, "undefined"), we = e.bind(null, "function"),
    ...
    function Ee(t, n) {
        if (Array.isArray(t) || "length" in t && r(t.length)) for (var e = 0; e < t.length; e++) n(e, t[e]); else Object.keys(t).forEach(function (e) {
            n(e, t[e])
        })
    }
    ...
    function Me(e, t) {
        for (var n = e || {}; (n = n.parentNode) && !/(9|11)/.test(n.nodeType);) if (!t || qe(n, t)) return n
    }
    ...
    function Ke(e, t) {
        if (xe(t)) {
            var n = getComputedStyle(e), o = l(n.paddingLeft) + l(n.paddingRight),
    ...
    function Xe(e, t) {
        if (xe(t)) {
            var n = getComputedStyle(e), o = l(n.paddingTop) + l(n.paddingBottom),
    ...
    function lt(e) {
        var t, n, o, r, i, l, a, s = je(e, "whiteSpace"), c = /line$/i.test(s), u = e.firstChild;
        if (!/pre(\-wrap)?$/i.test(s)) for (; u;) {
            if (l = u.nextSibling, t = u.nodeValue, (n = u.nodeType) === Se && u.firstChild && lt(u), n === Te) {
                ...
                if (rt(u) && r) {
                    for (i = r; i.lastChild;) for (i = i.lastChild; We(i, "sceditor-ignore");) i = d(i, !0);
    ...
    var n, h, m, st = {
            ...
            parserOptions: {},
            dropDownCss: {}
        }, g = navigator.userAgent, v = function () {
        ...
        }(), ct = "-ms-ime-align" in document.documentElement.style, ut = /iPhone|iPod|iPad| wosbrowser\//i.test(g),
        dt = ((m = document.createElement("div")).contentEditable = !0, "contentEditable" in document.documentElement && "true" === m.contentEditable && (h = /Opera Mobi|Opera Mini/i.test(g), /Android/i.test(g) && (h = !0, /Safari/.test(g) && (h = !(n = /Safari\/(\d+)/.exec(g)) || !n[1] || n[1] < 534)), / Silk\//i.test(g) && (h = !(n = /AppleWebKit\/(\d+)/.exec(g)) || !n[1] || n[1] < 534), ut && (h = /OS [0-4](_\d)+ like Mac/i.test(g)), /Firefox/i.test(g) && (h = !1), /OneBrowser/i.test(g) && (h = !1), "UCWEB" === navigator.vendor && (h = !1), v <= 9 && (h = !0), !h)),
    ...
    var mt = {
        ...
        left: {
            state: function (e) {
                if (e && 3 === e.nodeType && (e = e.parentNode), e) {
                    var t = "ltr" === je(e, "direction"), n = je(e, "textAlign");
        ...
        size: {
            _dropDown: function (t, e, n) {
                ...
                for (var r = 1; r <= 7; r++) Re(o, ht("sizeOpt", {size: r}, !0));
        ...
        table: {
            exec: function (e) {
                ...
                Re(i, ht("table", {
                    ...
                    var t = Number(He(i, "#rows")[0].value), n = Number(He(i, "#cols")[0].value), o = "<table>";
        ...
        link: {
            _dropDown: function (t, e, n) {
                var o = De("div");
                Re(o, ht("link", {url: t._("URL:"), desc: t._("Description (optional):"), ins: t._("Insert")}, !0));
                var r = He(o, "#link")[0];
        ...
        quote: {
            exec: function (e, t, n) {
                ...
                t ? (o = o + (n = n ? "<cite>" + n + "</cite>" : "") + t + r, r = null) : "" === this.getRangeHelper().selectedHtml() && (r = (x ? "" : "<br />") + r), this.wysiwygEditorInsertHtml(o, r)
            }, tooltip: "Insert a Quote"
        },
        emoticon: {
            exec: function (f) {
                var p = this, h = function (e) {
                    var t, n, o = p.opts, r = o.emoticonsRoot || "", i = o.emoticonsCompat, l = p.getRangeHelper(),
                        a = i && " " !== l.getOuterText(!0, 1) ? " " : "",
                        s = i && " " !== l.getOuterText(!1, 1) ? " " : "", c = De("div"), u = De("div"),
                    ...
                    }), !e && o.emoticons.more && (Re(t = De("a", {className: "sceditor-more"}), document.createTextNode(p._("More"))), Fe(t, "click", function (e) {
        ...
        youtube: {
            _dropDown: function (i, e, l) {
                ...
                Re(a, ht("youtubeMenu", {
                    ...
                    var t = He(a, "#link")[0].value, n = t.match(/(?:v=|v\/|embed\/|youtu.be\/)(.{11})/),
                        o = t.match(/[&|?](?:star)?t=((\d+[hms]?){1,3})/), r = 0;
                ...
                mt.youtube._dropDown(n, e, function (e, t) {
                    n.wysiwygEditorInsertHtml(ht("youtube", {id: e, time: t}))
                })
            }, tooltip: "Insert a YouTube video"
        },
        date: {
            _date: function (e) {
                var t = new Date, n = t.getYear(), o = t.getMonth() + 1, r = t.getDate();
        ...
        time: {
            _time: function () {
                var e = new Date, t = e.getHours(), n = e.getMinutes(), o = e.getSeconds();
    ...
    function gt(i) {
        var r = this, l = [], a = function (e) {
            return "signal" + e.charAt(0).toUpperCase() + e.slice(1)
        }, e = function (e, t) {
            e = [].slice.call(e);
            var n, o, r = a(e.shift());
            for (n = 0; n < l.length; n++) if (r in l[n] && (o = l[n][r].apply(i, e), t)) return o
        };
        r.call = function () {
            e(arguments, !1)
            ...
            if (r.exists(e)) for (var t = l.length; t--;) if (l[t] instanceof k[e]) return !0;
            return !1
    ...
    gt.plugins = k;
    var C = v && v < 11, E = function (e, t, n) {
        var o, r, i, l, a, s = "", c = e.startContainer, u = e.startOffset;
        ...
        return {node: a || c, offset: u, text: s}
    };

    function vt(i, e) {
        var l, a, s = e || i.contentDocument || i.document, c = "sceditor-start-marker", u = "sceditor-end-marker",
            y = this;
        y.insertHTML = function (e, t) {
            ...
            if ("string" == typeof e ? (t && (e += y.selectedHtml() + t), r = et(e)) : (Re(r, e), t && (Re(r, y.selectedRange().extractContents()), Re(r, t))), o = r.lastChild) {
                ...
                if (ot(o) ? o.lastChild || Re(o, document.createTextNode("​")) : o = r, y.removeMarkers(), Re(o, l(c)), Re(o, l(u)), n) {
                    var i = De("div");
            ...
            var n = a(e, t), o = y.selectedRange(), r = o.commonAncestorContainer;
            if (!n) return !1;
            ...
            var n = y.selectedRange(), o = y.cloneSelected();
            if (!o) return !1;
            ...
            var e, t = y.selectedRange(), n = y.getMarker(c), o = y.getMarker(u);
            if (!n || !o || !t) return !1;
            ...
            for (r && v++, i = i || "", u = (l = y.getOuterText(!0, v)).length, l += i, t && (l += y.getOuterText(!1, v)); m--;) if (p = (f = e[m][0]).length, c = Math.max(0, u - p - g), s = -1, r ? (a = l.substr(c).match(new RegExp(h + ft(f) + h))) && (s = a.index + c + a[1].length) : s = l.indexOf(f, c), -1 < s && s <= u && u <= s + p + g) return d = u - s, y.selectOuterText(d, p - d - (/^\S/.test(i) ? 1 : 0)), y.insertHTML(e[m][1]), !0;
            return !1
    ...
    var yt = window, bt = document, xt = v, wt = xt && xt < 11, kt = /^image\/(p?jpe?g|gif|png|bmp)$/i;

    function Ct(a, e) {
        var l, w, u, s, i, h, d, c, f, p, m, g, t, v, r, y, b, x, k, n, o, C, E, S, T, D, M, N, B, R, H, I, F, z, A, O,
            _, L, j, P, q, V, W, $, U, Y, K, X, Q, G, J, Z, ee, te, ne, oe, re, ie, le, ae, se, ce, ue, de = this,
            fe = {}, pe = [], he = [], me = {}, ge = {}, ve = {};
        de.commands = ke(!0, {}, e.commands || mt);
        var ye = de.opts = ke(!0, {}, st, e);
        de.opts.emoticons = e.emoticons || st.emoticons, M = function () {
            a._sceditor = de, ye.locale && "en" !== ye.locale && F(), Ve(w = De("div", {className: "sceditor-container"}), a), je(w, "z-index", ye.zIndex), xt && $e(w, "ie ie" + xt), n = a.required, a.required = !1;
            var e = Ct.formats[ye.format];
            "init" in (l = e ? new e : {}) && l.init.call(de), I(), L(), z(), H(), A(), O(), dt || de.toggleSourceMode(), G();
            var t = function () {
            ...
            var e = xt ? "ie ie" + xt : "";
            e += ut ? " ios" : "", (d = s.contentDocument).open(), d.write(ht("html", {
                attrs: ' class="' + e + '"',
                spellcheck: ye.spellcheck ? "" : 'spellcheck="false"',
                charset: ye.charset,
                style: ye.style
            })), d.close(), h = d.body, i = s.contentWindow, de.readOnly(!!ye.readOnly), (ut || ct || xt) && (Xe(h, "100%"), xt || Fe(h, "touchend", de.focus));
            var t = Ae(a, "tabindex");
            ...
            var e = a.form, t = "compositionstart compositionend", n = "keydown keyup keypress focus blur contextmenu",
            ...
            var i, l = de.commands, a = (ye.toolbarExclude || "").split(","), e = ye.toolbar.split("|");
            u = De("div", {
                className: "sceditor-toolbar",
                unselectable: "on"
            }), ye.icons in Ct.icons && (D = new Ct.icons[ye.icons]), Ee(e, function (e, t) {
                i = De("div", {className: "sceditor-group"}), Ee(t.split(","), function (e, t) {
                    var n, o, r = l[t];
                    !r || -1 < a.indexOf(t) || (o = r.shortcut, n = ht("toolbarButton", {
                        ...
                        name: t,
                        state: r.state
                    }) : be(r.exec) && he.push({name: t, state: r.exec}), Re(i, n), ge[t] = n)
                }), i.firstChild && Re(u, i)
            }), Re(ye.toolbarContainer || w, u)
        }, _ = function () {
            var o, r, i, l, t, n, e = De("div", {className: "sceditor-grip"}),
                a = De("div", {className: "sceditor-resize-cover"}), s = "touchmove mousemove",
                c = "touchcancel touchend mouseup", u = 0, d = 0, f = 0, p = 0, h = 0, m = 0, g = Ke(w), v = Xe(w),
                y = !1, b = de.rtl();
            ...
            var e = ye.emoticons, n = ye.emoticonsRoot || "";
            e && (ve = ke({}, e.more, e.dropdown, e.hidden)), Ee(ve, function (e, t) {
                ve[e] = ht("emoticon", {
                    key: e,
                    url: n + (t.url || t),
                    tooltip: t.tooltip || e
                }), ye.emoticonsEnabled && pe.push(De("img", {src: n + (t.url || t)}))
            })
        }, ne = function () {
            var e, t, n = h.firstChild, o = !!ye.autofocusEnd;
            if (Ge(w)) {
                if (de.sourceMode()) return t = o ? c.value.length : 0, void c.setSelectionRange(t, t);
                if (lt(h), o) for ((n = h.lastChild) || (n = De("p", {}, d), Re(h, n)); n.lastChild;) n = n.lastChild, !wt && qe(n, "br") && n.previousSibling && (n = n.previousSibling);
            ...
            if (!de.maximize()) {
                if (clearTimeout(E), E = !1, !C) {
                    ...
                    C = {min: t, max: ye.resizeMaxHeight || 2 * t}
                }
                var n = bt.createRange();
                n.selectNodeContents(h);
                var o = n.getBoundingClientRect(), r = d.documentElement.clientHeight - 1, i = o.bottom - o.top,
                    l = de.height() + 1 + (i - r);
            ...
            }, ye.dropDownCss), je(f = De("div", {className: "sceditor-dropdown " + i}), r), Re(f, n), Re(w, f), Fe(f, "click focusin", function (e) {
                e.stopPropagation()
            }), setTimeout(function () {
                if (f) {
            ...
            var t, n, o = xt || ct, r = h, i = e.clipboardData;
            if (i && !o) {
                var l = {}, a = i.types, s = i.items;
                e.preventDefault();
                ...
                setTimeout(function () {
                    var e = r.innerHTML;
                    r.innerHTML = "", Re(r, T), r.scrollTop = u, T = !1, v.restoreRange(), P({html: e})
                }, 0)
            }
        }, P = function (e) {
            var t = De("div", {}, d);
            r.call("pasteRaw", e), Qe(w, "pasteraw", e), e.html ? (t.innerHTML = e.html, it(t)) : t.innerHTML = pt(e.text || "");
            ...
            var n, o, r = c.selectionStart, i = c.selectionEnd;
            ...
            var e, c, u, d, t, f, p;
            ye.emoticonsEnabled && (e = h, c = ve, u = ye.emoticonsCompat, d = e.ownerDocument, t = "(^|\\s| | | | |$)", f = [], p = {}, Me(e, "code") || (Ee(c, function (e) {
                p[e] = new RegExp(t + ft(e) + t), f.push(e)
            }), f.sort(function (e, t) {
                return t.length - e.length
            }), function e(t) {
                for (t = t.firstChild; t;) {
                    if (t.nodeType !== Se || qe(t, "code") || e(t), t.nodeType === Te) for (var n = 0; n < f.length; n++) {
                        var o = t.nodeValue, r = f[n], i = u ? o.search(p[r]) : o.indexOf(r);
                        if (-1 < i) {
                            var l = o.indexOf(r, i), a = et(c[r], d), s = o.substr(l + r.length);
            ...
            !dt && e || (e || (v.saveRange(), v.clear()), de.blur(), e ? de.setWysiwygEditorValue(de.getSourceEditorValue()) : de.setSourceEditorValue(de.getWysiwygEditorValue()), p = null, Le(c), Le(s), Ye(w, "wysiwygMode", e), Ye(w, "sourceMode", !e), Q(), G())
        }, J = function () {
            ...
            y !== t && (e = y, y = t, b = v.getFirstBlockParent(t), Qe(w, "nodechanged", {oldNode: e, newNode: y}))
            ...
            if (de.readOnly()) Ee(He(u, n), function (e, t) {
                ...
                for (var i = 0; i < he.length; i++) {
                    var l = 0, a = ge[he[i].name], s = he[i].state, c = r && !a._sceTxtMode || !r && !a._sceWysiwygMode;
                    if (be(s)) {
                        if (!r) try {
            ...
            if (!e.defaultPrevented && (de.closeDropDown(), 13 === e.which) && !qe(b, "li,ul,ol") && tt(b)) {
                ...
                if (v.insertNode(t), !wt) {
                    var n = t.parentNode, o = n.lastChild;
            ...
            for (var r = (e = e.split(" ")).length; r--;) if (we(t)) {
                var i = "scewys" + e[r], l = "scesrc" + e[r];
            ...
            if (we(e)) de.bind("focus", e, t, n); else if (de.inSourceMode()) c.focus(); else {
            ...
            var n = 0, o = de.emoticonsCache, t = String.fromCharCode(e.which);
            ...
            !function (e, t) {
                var n = /[^\s\xA0\u2002\u2003\u2009\u00a0]+/, o = e && He(e, "img[data-sceditor-emoticon]");
                if (e && o.length) for (var r = 0; r < o.length; r++) {
                    var i = o[r], l = i.parentNode, a = i.previousSibling, s = i.nextSibling;
                    if (a && n.test(a.nodeValue.slice(-1)) || s && n.test((s.nodeValue || "")[0])) {
                        var c = t.cloneSelected(), u = -1, d = c.startContainer, f = a.nodeValue;
            ...
            return e || !1 === e ? ((ye.emoticonsEnabled = e) ? (Fe(h, "keypress", oe), de.sourceMode() || (v.saveRange(), N(), le(!1), v.restoreRange())) : (Ee(He(h, "img[data-sceditor-emoticon]"), function (e, t) {
                var n = Pe(t, "sceditor-emoticon"), o = d.createTextNode(n);
                t.parentNode.replaceChild(o, t)
            }), ze(h, "keypress", oe), le()), de) : ye.emoticonsEnabled
        }, de.css = function (e) {
            return o || (o = De("style", {id: "inline"}, d), Re(d.head, o)), be(e) ? (o.styleSheet ? o.styleSheet.cssText = e : o.innerHTML = e, de) : o.styleSheet ? o.styleSheet.cssText : o.innerHTML
        }, q = function (e) {
            var t = [], n = {
                "`": "~",
                1: "!",
            ...
            for (var e = b; !tt(e) || rt(e, !0);) if (!(e = e.parentNode) || qe(e, "body")) return;
            return e
            ...
            if (r && (r.hasHandler("valuechangedEvent") || le.hasHandler)) {
                ...
                e = (m = !1) !== e && !d.getElementById("sceditor-start-marker"), g && (clearTimeout(g), g = !1), o && e && v.saveRange(), (t = n ? c.value : h.innerHTML) !== le.lastVal && (le.lastVal = t, Qe(w, "valuechanged", {rawValue: n ? de.val() : t})), o && e && v.removeMarkers()
            }
        }, ae = function () {
            g && le()
        }, se = function (e) {
            var t = e.which, n = se.lastChar, o = 13 === n || 32 === n, r = 8 === n || 46 === n;
    ...
    Ct.locale = {}, Ct.formats = {}, Ct.icons = {}, Ct.command = {
        ...
        locale: Ct.locale,
        icons: Ct.icons,
        utils: {each: Ee, isEmptyObject: t, extend: ke},
        plugins: gt.plugins,
        formats: Ct.formats,
        create: function (e, t) {
            t = t || {}, Me(e, ".sceditor-container") || (t.runWithoutWysiwygSupport || dt) && new Ct(e, t)
        },
        instance: function (e) {
            return e._sceditor
        }
    ...
    "use strict";
    var f = e.escapeEntities, a = e.escapeUriScheme, h = e.dom, t = e.utils, m = h.css, g = h.attr, v = h.is,
        n = t.extend, s = t.each, o = e.ie, y = o && o < 11, b = "data-sceditor-emoticon", i = e.command.get,
        x = {always: 1, never: 2, auto: 3}, r = {
            bold: {txtExec: ["[b]", "[/b]"]},
            italic: {txtExec: ["[i]", "[/i]"]},
            ...
            font: {
                tags: {font: {face: null}}, styles: {"font-family": null}, quoteType: x.never, format: function (e, t) {
                    var n;
                    return v(e, "font") && (n = g(e, "face")) || (n = m(e, "font-family")), "[font=" + E(n) + "]" + t + "[/font]"
                }, html: '<font face="{defaultattr}">{0}</font>'
            },
            size: {
                tags: {font: {size: null}}, styles: {"font-size": null}, format: function (e, t) {
                    var n = g(e, "size"), o = 2;
            ...
            color: {
                tags: {font: {color: null}}, styles: {color: null}, quoteType: x.never, format: function (e, t) {
                    var n;
            ...
            emoticon: {
                allowsEmpty: !0, tags: {img: {src: null, "data-sceditor-emoticon": null}}, format: function (e, t) {
                    return g(e, b) + t
                }, html: "{0}"
            },
            ...
            url: {
                allowsEmpty: !0, tags: {a: {href: null}}, quoteType: x.never, format: function (e, t) {
                    var n = g(e, "href");
            ...
            email: {
                quoteType: x.never, html: function (e, t, n) {
                    return '<a href="mailto:' + (f(t.defaultattr, !0) || n) + '">' + n + "</a>"
                }
            },
            quote: {
                tags: {blockquote: null}, isInline: !1, quoteType: x.never, format: function (e, t) {
    ...
    var T = "open", D = "content", M = "newline", N = "close";
    ...
    function B(e) {
        ...
        function l(e, t) {
            ...
            return e === T && (n = t.match(/\[([^\]\s=]+)(?:([^\]]+))?\]/)) && (r = i(n[1]), n[2] && (n[2] = n[2].trim()) && (o = function (e) {
                var t, n = /([^\s=]+)=(?:(?:(["'])((?:\\\2|[^\2])*?)\2)|((?:.(?!\s\S+=))*.))/g, o = {};
                if ("=" === e.charAt(0) && e.indexOf("=", 1) < 0) o.defaultattr = E(e.substr(1)); else for ("=" === e.charAt(0) && (e = "defaultattr" + e); t = n.exec(e);) o[i(t[1])] = E(t[3]) || t[4];
                return o
        ...
        h.opts = n({}, B.defaults, e), h.tokenize = function (e) {
            var t, n, o, r = [], i = [{type: D, regex: /^([^\[\r\n]+|\[)/}, {type: M, regex: /^(\r\n|\r|\n)/}, {
                type: T,
                regex: /^\[[^\[\]]+\]/
            }, {type: N, regex: /^\[\/[^\[\]]+\]/}];
            e:for (; e.length;) {
                for (o = i.length; o--;) if (n = i[o].type, (t = e.match(i[o].regex)) && t[0]) {
            ...
            var n = function (e) {
                var t, n, o, r, i, l, a = [], s = [], c = [], u = function () {
                    return v(c)
                }, d = function (e) {
                ...
                for (; t = e.shift();) switch (l = e[0], m(u(), t) || t.type === N && u() && t.name === u().name || (t.name = "#", t.type = D), t.type) {
                    case T:
                        ...
                        break;
                    case N:
                        if (u() && t.name !== u().name && f("/" + t.name) && c.pop(), u() && t.name === u().name) u().closing = t, c.pop(); else if (p(t.name, T, c)) {
                            for (; o = c.pop();) {
                                if (o.name === t.name) {
                                    o.closing = t;
                                    break
            ...
            return o.fixInvalidNesting && function e(t, n, o, r) {
                ...
                n = n || [];
                r = r || t;
                for (l = 0; l < t.length; l++) if ((i = t[l]) && i.type === T) {
                    if (o && !d(i)) {
            ...
            return function e(t, n) {
                ...
                for (; 0 < t.length;) if (o = t.shift()) {
                    if (o.type === T) u = o.children[o.children.length - 1] || {}, r = w[o.name], a = n && c(r), i = e(o.children, !1), r && r.html ? (c(r) || !c(w[u.name]) || r.isPreFormatted || r.skipLastLineBreak || y || (i += "<br />"), C(r.html) ? l = r.html.call(h, o, o.attrs, i) : (o.attrs[0] = i, l = k(r.html, o.attrs))) : l = o.val + i + (o.closing ? o.closing.val : ""); else {
                        if (o.type === M) {
                            if (!n) {
                                d.push("<br />");
                                continue
            ...
            return function e(t) {
                ...
                for (; 0 < t.length;) if (n = t.shift()) if (r = w[n.name], i = !(!r || !1 !== r.isInline), l = r && r.isSelfClosing, s = i && h.opts.breakBeforeBlock && !1 !== r.breakBefore || r && r.breakBefore, c = i && !l && h.opts.breakStartBlock && !1 !== r.breakStart || r && r.breakStart, u = i && h.opts.breakEndBlock && !1 !== r.breakEnd || r && r.breakEnd, d = i && h.opts.breakAfterBlock && !1 !== r.breakAfter || r && r.breakAfter, a = (r ? r.quoteType : null) || h.opts.quoteType || x.auto, r || n.type !== T) if (n.type === T) {
                    if (s && f.push("\n"), f.push("[" + n.name), n.attrs) for (o in n.attrs.defaultattr && (f.push("=", g(n.attrs.defaultattr, a, "defaultattr")), delete n.attrs.defaultattr), n.attrs) n.attrs.hasOwnProperty(o) && f.push(" ", o, "=", g(n.attrs[o], a, o));
                    f.push("]"), c && f.push("\n"), n.children && f.push(e(n.children)), l || r.excludeClosing || (u && f.push("\n"), f.push("[/" + n.name + "]")), d && f.push("\n"), n.closing && l && f.push(n.closing.val)
                } else f.push(n.val); else f.push(n.val), n.children && f.push(e(n.children)), n.closing && f.push(n.closing.val);
                return f.join("")
            }(h.parse(e, t))
        }
    }
    ...
    function d() {
        ...
        function p(e) {
            var c = function (e, a) {
                ...
                return h.traverse(e, function (e) {
                    var t = "", n = e.nodeType, o = e.nodeName.toLowerCase(), r = u[o], i = e.firstChild, l = !0;
                    if ("object" == typeof a && (l = -1 < a.indexOf(o), v(e, "img") && g(e, b) && (l = !0), l || (r = a)), 3 === n || 1 === n) if (1 === n) {
                        ...
                        "iframe" !== o && (t = c(e, r)), l ? ("code" !== o && (t = d(e, t = f(e, t = d(e, t)), !0)), t = f(e, t, !0), s += function (e, t) {
                            var n = e.nodeName.toLowerCase(), o = h.isInline;
                            if (!o(e, !0) || "br" === n) {
        ...
        function e(e, t, n) {
            ...
            return e || n ? (o = s, a = document.createElement("div"), l = function (e, t) {
                if (!h.hasStyling(e)) {
                    if (y || 1 !== e.childNodes.length || !v(e.firstChild, "br")) for (; i = e.firstChild;) a.insertBefore(i, e);
                    if (t) {
                        var n = a.lastChild;
        ...
        function t(e, t, n, o) {
            var r, i, l = (n = n || document).createElement("div"), a = n.createElement("div"),
    ...
    c.prototype = {
        clone: function () {
            ...
            var t, n = this.clone(), o = this.children.indexOf(e);
